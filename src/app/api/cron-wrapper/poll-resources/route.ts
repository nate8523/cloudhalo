/**
 * Vercel Cron Wrapper for poll-resources
 *
...
export async function GET(request: NextRequest) {
  ...
  const method = 'GET'
  const path = '/api/cron/poll-resources'
  const body = ''
  ...
  try {
    ...
    logSecureError('CronWrapper:PollResources', error, {
      endpoint: 'GET /api/cron-wrapper/poll-resources'
    })
